...
export const AboutPage = () => {
  return (
    <div className="min-h-screen  mx-auto bg-background dark:bg-white transition-colors duration-300">
      {/* About Section */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 pt-24 md:pt-32">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-4xl mx-auto">
          <div className="relative h-48 sm:h-64 md:h-80 flex justify-center">
            <div className="aspect-video rounded-2xl w-[80%] sm:w-[85%] md:w-[90%] h-full dark:bg-white bg-gray-800 border-primary border-2 shadow-2xl hover:shadow-xl transition-all duration-300 p-3 sm:p-4 relative">
